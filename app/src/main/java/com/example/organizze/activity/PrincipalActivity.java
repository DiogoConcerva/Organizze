...
public class PrincipalActivity extends AppCompatActivity {
    ...
    public void excluirMovimentacao(RecyclerView.ViewHolder viewHolder){
        ...
        alertDialog.setMessage("Você tem certeza que desaja excluir essa movimentação da conta?");
    ...
    // Método que recupera movimentações
    ...
    // Método que configura o calendarview
    ...
    // Método adiciona receita
    public void adicionarReceita(View view){
        startActivity(new Intent(this, ReceitaActivity.class));
    }

    // Método adiciona despesa
    public void adicionarDespesa(View view){
        startActivity(new Intent(this, DespesaActivity.class));
    }

    // Método que chama recuperarResumo() e recuperarMovimentacoes()
    @Override
    ...
    // Método remove EventListener de usuarioRef e movimentacaoRef
    @Override
